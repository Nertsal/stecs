...
struct GameWorld {
    units: StructOf<Arena<Unit>>,         // UnitStructOf<ArenaFamily>,
    corpses: StructOf<Arena<Corpse>>,     // CorpseStructOf<ArenaFamily>,
    particles: StructOf<Arena<Particle>>, // ParticleStructOf<ArenaFamily>,
}
